...
### [Coding Challenge Platform](https://github.com/shadowfightbeast/code-judge) | Go, React, Kafka, Docker, Redis | Nov 2024

- Developed a full-stack coding platform enabling users to solve and submit problems in C++, Java, and JavaScript with real-time feedback.
- Architected a Kafka-based job queue system to decouple submission handling from API server, ensuring high throughput and fault tolerance.
- Built a Docker-based code execution engine, launching isolated containers per submission to compile, run, and validate code securely.
